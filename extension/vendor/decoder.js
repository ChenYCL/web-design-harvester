// Auto-generated wrapper around Figma kiwi codec (schema hash 93e09dd71f90).
...
exports["TextElementGrouping"] = {
  "0": "CHARACTER",
  "1": "CHARACTER_NO_WHITESPACE",
  "2": "WORD",
  "3": "LINE",
  "4": "PARAGRAPH",
  "CHARACTER": 0,
  "CHARACTER_NO_WHITESPACE": 1,
  "WORD": 2,
  "LINE": 3,
  "PARAGRAPH": 4
};
exports["TextElementDelayOrder"] = {
  "0": "LEFT_RIGHT",
  "1": "RIGHT_LEFT",
  "2": "CENTER_OUT",
  "3": "RANDOM",
...
exports["decodeDerivedTextData"] = function (bb) {
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 13:
        var length = bb.readVarUint();
        var values = result["checklistMarkers"] = Array(length);
        for (var i = 0; i < length; i++) values[i] = this["decodeChecklistMarker"](bb);
        break;
...
exports["encodeDerivedTextData"] = function (message, bb) {
  ...
  var value = message["checklistMarkers"];
  if (value != null) {
    bb.writeVarUint(13);
    var values = value, n = values.length;
    bb.writeVarUint(n);
    for (var i = 0; i < n; i++) {
      value = values[i];
      this["encodeChecklistMarker"](value, bb);
    }
  }
  bb.writeVarUint(0);
...
exports["decodeChecklistMarker"] = function (bb) {
  var result = {};
  if (!(bb instanceof this.ByteBuffer)) {
    bb = new this.ByteBuffer(bb);
  }
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 3:
        result["lineIndex"] = bb.readVarUint();
        break;

      case 4:
        result["isChecked"] = !!bb.readByte();
        break;
...
exports["encodeChecklistMarker"] = function (message, bb) {
  var isTopLevel = !bb;
  if (isTopLevel) bb = new this.ByteBuffer();
  ...
  var value = message["lineIndex"];
  if (value != null) {
    bb.writeVarUint(3);
    bb.writeVarUint(value);
  }

  var value = message["isChecked"];
  if (value != null) {
    bb.writeVarUint(4);
    bb.writeByte(value);
  }
...
exports["decodeNodeChange"] = function (bb) {
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 606:
        result["stackChildMarginTop"] = bb.readVarFloat();
        break;

      case 607:
        result["stackChildMarginRight"] = bb.readVarFloat();
        break;

      case 608:
        result["stackChildMarginBottom"] = bb.readVarFloat();
        break;

      case 609:
        result["stackChildMarginLeft"] = bb.readVarFloat();
        break;
      ...
      case 610:
        result["textElementDelayBehaviour"] = this["decodeTextElementDelayBehaviour"](bb);
        break;
      ...
      case 611:
        result["previewRasterSnapshot"] = this["decodePreviewRasterSnapshot"](bb);
        break;
...
exports["encodeNodeChange"] = function (message, bb) {
  ...
  var value = message["stackChildMarginTop"];
  if (value != null) {
    bb.writeVarUint(606);
    bb.writeVarFloat(value);
  }

  var value = message["stackChildMarginRight"];
  if (value != null) {
    bb.writeVarUint(607);
    bb.writeVarFloat(value);
  }

  var value = message["stackChildMarginBottom"];
  if (value != null) {
    bb.writeVarUint(608);
    bb.writeVarFloat(value);
  }

  var value = message["stackChildMarginLeft"];
  if (value != null) {
    bb.writeVarUint(609);
    bb.writeVarFloat(value);
  }
  ...
  var value = message["textElementDelayBehaviour"];
  if (value != null) {
    bb.writeVarUint(610);
    this["encodeTextElementDelayBehaviour"](value, bb);
  }
  ...
  var value = message["previewRasterSnapshot"];
  if (value != null) {
    bb.writeVarUint(611);
    this["encodePreviewRasterSnapshot"](value, bb);
  }
...
exports["decodePreviewRasterSnapshot"] = function (bb) {
  var result = {};
  if (!(bb instanceof this.ByteBuffer)) {
    bb = new this.ByteBuffer(bb);
  }
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 1:
        result["paint"] = this["decodePaint"](bb);
        break;
...
exports["encodePreviewRasterSnapshot"] = function (message, bb) {
  var isTopLevel = !bb;
  if (isTopLevel) bb = new this.ByteBuffer();

  var value = message["paint"];
  if (value != null) {
    bb.writeVarUint(1);
    this["encodePaint"](value, bb);
  }
...
exports["VariableField"] = {
  ...
  "76": "TEXT_ELEMENT_DELAY",
  "77": "TRANSFORM_3D_ROTATION_XYZ",
  "78": "STACK_CHILD_MARGIN_TOP",
  "79": "STACK_CHILD_MARGIN_RIGHT",
  "80": "STACK_CHILD_MARGIN_BOTTOM",
  "81": "STACK_CHILD_MARGIN_LEFT",
  "MISSING": 0,
  "CORNER_RADIUS": 1,
  "PARAGRAPH_SPACING": 2,
  "PARAGRAPH_INDENT": 3,
  ...
  "TEXT_ELEMENT_DELAY": 76,
  "TRANSFORM_3D_ROTATION_XYZ": 77,
  "STACK_CHILD_MARGIN_TOP": 78,
  "STACK_CHILD_MARGIN_RIGHT": 79,
  "STACK_CHILD_MARGIN_BOTTOM": 80,
  "STACK_CHILD_MARGIN_LEFT": 81
};
...
exports["decodeTextLineData"] = function (bb) {
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 11:
        result["isLineChecked"] = !!bb.readByte();
        break;
...
exports["encodeTextLineData"] = function (message, bb) {
  ...
  var value = message["isLineChecked"];
  if (value != null) {
    bb.writeVarUint(11);
    bb.writeByte(value);
  }
...
exports["decodeLength"] = function (bb) {
  var result = {};
  if (!(bb instanceof this.ByteBuffer)) {
    bb = new this.ByteBuffer(bb);
  }
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 2:
        result["unit"] = this["LengthUnit"][bb.readVarUint()];
        break;
...
exports["encodeLength"] = function (message, bb) {
  var isTopLevel = !bb;
  if (isTopLevel) bb = new this.ByteBuffer();
  ...
  if (value != null) {
    bb.writeVarUint(2);
    var encoded = this["LengthUnit"][value]; if (encoded === void 0) throw new Error("Invalid value " + JSON.stringify(value) + " for enum \"LengthUnit\""); bb.writeVarUint(encoded);
  }
  bb.writeVarUint(0);
...
exports["decodeVariableAnyValue"] = function (bb) {
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 32:
        result["lengthValue"] = this["decodeLength"](bb);
        break;

      case 33:
        result["transitionParameterValue"] = this["decodeTransitionParameterValue"](bb);
        break;
...
exports["encodeVariableAnyValue"] = function (message, bb) {
  ...
  var value = message["lengthValue"];
  if (value != null) {
    bb.writeVarUint(32);
    this["encodeLength"](value, bb);
  }

  var value = message["transitionParameterValue"];
  if (value != null) {
    bb.writeVarUint(33);
    this["encodeTransitionParameterValue"](value, bb);
  }
  bb.writeVarUint(0);
...
exports["decodeTextElementDelayBehaviour"] = function (bb) {
  var result = {};
  if (!(bb instanceof this.ByteBuffer)) {
    bb = new this.ByteBuffer(bb);
  }
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 2:
        result["grouping"] = this["TextElementGrouping"][bb.readVarUint()];
        break;

      case 3:
        result["delayMs"] = bb.readVarFloat();
        break;

      case 4:
        result["order"] = this["TextElementDelayOrder"][bb.readVarUint()];
        break;
...
exports["encodeTextElementDelayBehaviour"] = function (message, bb) {
  var isTopLevel = !bb;
  if (isTopLevel) bb = new this.ByteBuffer();
  ...
  var value = message["grouping"];
  if (value != null) {
    bb.writeVarUint(2);
    var encoded = this["TextElementGrouping"][value]; if (encoded === void 0) throw new Error("Invalid value " + JSON.stringify(value) + " for enum \"TextElementGrouping\""); bb.writeVarUint(encoded);
  }

  var value = message["delayMs"];
  if (value != null) {
    bb.writeVarUint(3);
    bb.writeVarFloat(value);
  }
  ...
  if (value != null) {
    bb.writeVarUint(4);
    var encoded = this["TextElementDelayOrder"][value]; if (encoded === void 0) throw new Error("Invalid value " + JSON.stringify(value) + " for enum \"TextElementDelayOrder\""); bb.writeVarUint(encoded);
  }
  bb.writeVarUint(0);
...
exports["decodeTransitionParameterValue"] = function (bb) {
  var result = {};
  if (!(bb instanceof this.ByteBuffer)) {
    bb = new this.ByteBuffer(bb);
  }
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 1:
        result["startValue"] = this["decodeKeyframeValueData"](bb);
        break;

      case 2:
        result["endValue"] = this["decodeKeyframeValueData"](bb);
        break;
...
exports["encodeTransitionParameterValue"] = function (message, bb) {
  var isTopLevel = !bb;
  if (isTopLevel) bb = new this.ByteBuffer();

  var value = message["startValue"];
  if (value != null) {
    bb.writeVarUint(1);
    this["encodeKeyframeValueData"](value, bb);
  }

  var value = message["endValue"];
  if (value != null) {
    bb.writeVarUint(2);
    this["encodeKeyframeValueData"](value, bb);
  }
...
exports["decodeNodeChatExchange"] = function (bb) {
  ...
  while (true) {
    switch (bb.readVarUint()) {
      ...
      case 5:
        result["sessionId"] = bb.readString();
        break;
